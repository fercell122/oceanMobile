        ...
        return (
          <ImageBackground
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.titleBold}>Quais são suas habilidades?</Text>

            <Text style={styles.paragraf}>Nos diga quais são suas habilidades</Text>
            ...
            <View style={styles.buttonsContainer}>
                ...
                style={[styles.button, styles.buttonPrimary]}>
                    ...
                    <Text style={styles.buttonText}>Finalizar
